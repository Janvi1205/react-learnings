const Product=(props)=>{
    return (
        <div style={{display:"inline-block",marginLeft:"80px",border:"1px solid black",padding:"20px",width:"200px",marginTop:"20px", textAlign:"center",borderRadius:"10px",backgroundColor:"rgb(249, 245, 240)"}}>
